...
namespace Basic_SQL_Client
{
    public partial class CrearBD : Form
    {
        ...
        public CrearBD(Principal principal)
        {
            InitializeComponent();
        ...
        //METODO PARA CUANDO SE DA CLICK A "CREAR BD"
        private void buttonCrearBD_Click(object sender, EventArgs e)
        {
             ...
             * 
             * SQL:
             * la consulta que espera en este caso: "create database "+textBoxCrearBD.Text (ya que es creación), donde
             ...
             */
            conexion.ejecutarSQL("create database "+textBoxCrearBD.Text, principal.resultado, principal.consola);
